 ...
 * Runs 10 consecutive loops under identical stochastic load parameters to compile averages.
 */
public class SimulationInheritance {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < RUNS; i++) {
            ...
            System.out.printf("Inheritance Run %d | Waiting: %.2f ms | Response: %.2f ms%n", (i + 1), wait, response);
        }
